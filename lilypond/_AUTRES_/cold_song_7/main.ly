...
melodie =  \relative c'{
  ...
  g2 r4. | a2~ a8 a4 | bes2~ bes8 bes4 | b2~ b8 b4 | c2~ c8 c4 | c2~ c8 b4 | c2 r4. | r2 r4. | r2 r4. | r2 r4. | r2 r4. | r2 r8 c4 |
  c4 bes8~ bes2 | bes4 bes8~ bes2 | bes4 a8~ a2 | a4 aes8~ aes2 |
  g2~ g8 g4 | c4 f,8~ f2 | e2~ e8 e4 | f2~ f8 b,4 | c2 r4. | r2 r4. | r2 r4. | r2 r4.
  f2~ f8 f4 | f2~ f8 f4 | g2~ g8 g4 | a2~ a8 a4 | bes2~ bes8 bes4 | b2~ b8 b4 | c2~ c8 c4 | d2~ d8 d4 | ees2 r4. | r2 r8 ees4 |
  d2~ d8 c4 | d2~ d8 d4 | b2 r4. | r2 r8 c4 | c4 bes8~ bes2 | bes4 aes8~ aes2 |
  aes4 g8~ g2 | g2~ g8 f4 | f4 ees8~ ees2 | d2~ d8 c4 | c2 r4. | r2 r4. | r2 r4. 
r2 r4.
}
...
harmonie =  \chordmode{
  ...
  \tuplet 8/7 {
    ...
    g1:min g1:7/f | c1:7/e g1:7/d | \break
    c1:min f1:dim7 | fis1:dim7 g1:7 | c1 c1:5+ \break |
    d1:3-.5-.7 c1:7 | f1 b1:dim7 | \break
    c1 des1:maj7 | c1:7 b1:dim7 | c1 f1:min | bes1:dim7 c1 | \break
    f1 bes1/d | ees1 c1:dim7 | \break
    bes1:min d1:dim7 | c1:min g1 | c1:min d1:7 | \break
    e1:3-.5-.7 f1:dim7 | g1:7/f c1:min/ees | bes1/d aes1/c |
